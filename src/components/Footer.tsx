...
const Footer = () => {
  const socialLinks = [
    { icon: Github, href: "https://github.com/darkcode", label: "GitHub" },
    { icon: Twitter, href: "https://twitter.com/darkcode", label: "Twitter" },
    { icon: Linkedin, href: "https://linkedin.com/company/darkcode", label: "LinkedIn" },
    { icon: Mail, href: "mailto:hello@darkcode.com", label: "Email" },
  ];
    ...
    <footer className="bg-card/50 border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="text-2xl font-bold mb-4">
              <span className="text-primary text-glow">DarkCode</span>
              <span className="text-foreground"> Rising</span>
            </div>
            <p className="text-muted-foreground">
              Where darkness meets innovation. Join us for an unforgettable hackathon experience.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border text-center text-muted-foreground">
          <p>&copy; 2026 DarkCode Rising. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
