  ...
  const prizes = [
    {
      ...
      place: "1st Place",
      amount: "$25,000",
      perks: ["Exclusive mentorship", "LinkedIn feature", "Tech goodie bag"],
      highlight: true,
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      place: "3rd Place",
      amount: "$10,000",
      perks: ["Recognition badge", "Networking access", "Tech merchandise"],
      highlight: false,
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-primary text-glow">Prizes</span> & Rewards
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Compete for incredible prizes, recognition, and opportunities that will elevate your career.
          </p>
        </div>
              ...
              >
                ...
                <div className="text-center space-y-4">
                  <div className={`w-20 h-20 rounded-full mx-auto flex items-center justify-center ${
                    prize.highlight ? "bg-primary/20 neon-glow" : "bg-primary/10"
                  }`}>
                  ...
                  <div>
                    ...
                    <div className="text-4xl font-bold text-primary text-glow">{prize.amount}</div>
                  </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground">
            Plus special category prizes, sponsor awards, and more surprises!
          </p>
        </div>
      </div>
    </section>
